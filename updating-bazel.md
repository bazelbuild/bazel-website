...
(see [https://www.bazel.build/breaking-changes-guide.html](https://www.bazel.build/breaking-changes-guide.html) for how
to roll out incompatible changes if you are the author of one).
...
3. Each of those issues has an associated `--incompatible_*` flag. For each of them, build your project 
   ...
   [migration recipe](https://docs.bazel.build/versions/master/backward-compatibility.html#incompatible-changes-and-migration-recipes):
